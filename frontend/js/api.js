/* ================= BASE DA API ================= */
function apiBase() {
  return (window.API_BASE_URL || "https://projeto-integrador1-backend.onrender.com/api").replace(/\/$/, "");
}
...
async function apiRequest(path, options = {}) {
  ...
  if (result.success === false) throw new Error(result.error || "Operação não concluída");
